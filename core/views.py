...
from .forms import CheckoutForm, CouponForm, RefundForm, PaymentForm, ReviewForm, ContactForm, UserRegistrationForm
...
def SingleView(request):
    return render(request, 'dashboard/single.html')
